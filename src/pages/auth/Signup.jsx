                ...
                <form className="flex flex-col w-full p-8 mt-10 bg-gray-100 rounded-lg lg:w-2/6 md:w-1/2 md:ml-auto md:mt-0">
                    ...
                    <div className="realtive mb-4">
                        ...
                        <input 
                            ...
                            name="firstName" 
                            className="
                            w-full px-3 py-1 mt-2 text-base leading-8 text-gray-700 transition-colors duration-200 ease-in-out border border-gray-300 rounded outline-noe 
                    ...
                    <div className="realtive mb-4">
                        <label htmlFor="mobileNumber" className="text-sm leading-7 text-gray-600">mobileNumber<span className="text-red-500">*</span></label>
                        <input 
                            type="tel" 
                            id="mobileNumber" 
                            name="mobileNumber" 
                    ...
                    <button className="w-ful px-8 py-2 text-lg text-white bg-yellow-500 border-0 rounded focus:outline-none hover:bg-yellow-600">Create Account</button>
